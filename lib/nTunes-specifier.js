...
// Returns a new specifier instance that points to the parent item of 'this'
nSpecifier.prototype.item = function() {
...
nSpecifier.prototype.get = function() {
  ...
  new nSpecifier(this.input + "/" + props.join(",")).exec(function(err, rtn) {
    // If more than one property was requested, then alias the property names
    // onto ther result Array for convienience.
