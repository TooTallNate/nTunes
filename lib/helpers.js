...
// We use "node-mime" to resolve mime-types. These 3 types need to be
// monkey-patched in until this pull request goes through:
//    http://github.com/bentomas/node-mime/pull/7
var patchTypes = {
  "buffer" : "application/octet-stream",
  "m4p" : "application/mp4",
  "m4a" : "audio/mp4"
}
for (var i in patchTypes) {
  if (!(i in mime.types)) {
    //console.error("monkey patching '" + i + "' into 'node-mime'");
    mime.types[i] = patchTypes[i];
  }
}
patchTypes = null;
